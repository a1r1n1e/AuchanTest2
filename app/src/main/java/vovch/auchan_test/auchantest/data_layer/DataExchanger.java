        ...
        try {
            if (items != null) {
                ...
                for (int i = 0; i < items.length; i++) {
                    ...
                    tempItems[i].setAuchanId(items[i].getAuchanId());
                    if(items[i].getImage() != null){
                        tempItems[i].setImage(items[i].getImage());
                    }
                    if(items[i].getPrice() != null){
                        tempItems[i].setPrice(items[i].getPrice());
                    }
                    if(items[i].getDescription() != null){
                        tempItems[i].setDescription(items[i].getDescription());
                    }
                    if(items[i].getCompound() != null){
                        tempItems[i].setCompound(items[i].getCompound());
                    }
