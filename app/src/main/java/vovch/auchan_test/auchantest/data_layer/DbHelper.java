...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String
            ...
            SqLiteBaseContruct.Items.COLUMN_NAME_ACTIVE + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_IMAGE + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_PRICE + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_DESCRIPTION + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_COMPOUND + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_STORE_ID + TEXT_TYPE + COMMA_SEP +
            SqLiteBaseContruct.Items.COLUMN_NAME_STORE + TEXT_TYPE + " )";
