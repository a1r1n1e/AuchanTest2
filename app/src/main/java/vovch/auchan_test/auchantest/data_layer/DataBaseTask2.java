    ...
    public SList[] getOffline(int taskType) {
        ...
        try {
            ...
            String[] projection = {
                    ...
                    SqLiteBaseContruct.Items.COLUMN_NAME_IMAGE,
                    SqLiteBaseContruct.Items.COLUMN_NAME_DESCRIPTION,
                    SqLiteBaseContruct.Items.COLUMN_NAME_COMPOUND,
                    SqLiteBaseContruct.Items.COLUMN_NAME_PRICE,
                    SqLiteBaseContruct.Items.COLUMN_NAME_STORE,
                    SqLiteBaseContruct.Items.COLUMN_NAME_STORE_ID};
                ...
                for (int i = 0; i < listNumber; i++) {
                    ...
                    if (cursor != null) {
                        ...
                        for (int j = 0; j < itemNumber; j++) {
                            ...
                            if(cursor.getString(10).equals("y")){
                                BitmapFactory.Options options = new BitmapFactory.Options();
                                options.inPreferredConfig = Bitmap.Config.ARGB_8888;

                                File f = new File(Environment.getExternalStorageDirectory()
                                        + File.separator + cursor.getString(15) + ".jpg");

                                Bitmap bitmap = BitmapFactory.decodeFile(f.getAbsolutePath(), options);
                                tempItem.setImage(bitmap);
                            }
                            tempItem.setDescription(cursor.getString(11));
                            tempItem.setCompound(cursor.getString(12));
                            tempItem.setPrice(cursor.getString(13));
                            tempItem.setAuchanId(cursor.getString(15));
            ...
            if(list != null && items != null) {
                ...
                for (Item item : items) {
                    ...
                    if(item.getImage() != null) {
                        values.put(SqLiteBaseContruct.Items.COLUMN_NAME_IMAGE, "y");
                    } else{
                        values.put(SqLiteBaseContruct.Items.COLUMN_NAME_IMAGE, "n");
                    }
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_DESCRIPTION, item.getDescription());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_COMPOUND, item.getCompound());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_PRICE, item.getPrice());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_STORE, "auchan");
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_STORE_ID, item.getAuchanId());
                    ...
                    if(item.getImage() != null) {
                        ...
                        item.getImage().compress(Bitmap.CompressFormat.JPEG, 40, bytes);
                        File f = new File(Environment.getExternalStorageDirectory()
                                + File.separator + String.valueOf(item.getAuchanId()) + ".jpg");
                        if(f.createNewFile()) {
        ...
        if (list != null && items != null) {
            try {
                ...
                for (int i = 0; i < items.length; i++) {
                    ...
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_DESCRIPTION, items[i].getDescription());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_COMPOUND, items[i].getCompound());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_PRICE, items[i].getPrice());
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_STORE, "auchan");
                    values.put(SqLiteBaseContruct.Items.COLUMN_NAME_STORE_ID, items[i].getAuchanId());
                    ...
                    if(items[i].getImage() != null) {
                        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
                        items[i].getImage().compress(Bitmap.CompressFormat.JPEG, 40, bytes);
                        File f = new File(Environment.getExternalStorageDirectory()
                                + File.separator + String.valueOf(itemId) + ".jpg");
                        if(f.createNewFile()) {
                            FileOutputStream fo = new FileOutputStream(f);
                            fo.write(bytes.toByteArray());
                            fo.close();
