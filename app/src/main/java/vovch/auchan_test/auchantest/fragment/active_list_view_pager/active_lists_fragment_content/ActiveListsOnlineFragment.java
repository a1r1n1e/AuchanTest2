package vovch.auchan_test.auchantest.fragment.active_list_view_pager.active_lists_fragment_content;
        ...
        if(getActivity() != null) {
            ...
            if (informer.getGroup().getState().equals(UserGroup.DEFAULT_GROUP_STATE_UNWATCHED)) {
                ...
                if (informer.isActive()) {
                    ...
                    Uri uri = Uri.parse("android.resource://vovch.auchan_test.auchantest/mipmap/alarm_custom_green_white");
                ...
                if (informer.isActive()) {
                    ...
                    Uri uri = Uri.parse("android.resource://vovch.auchan_test.auchantest/mipmap/small_alarm_green");
                    attentionButton.setImageURI(uri);
                    attentionButtonFrame.addView(attentionButton);
                }
            }
